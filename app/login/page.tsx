...
const DEMO_CLIENT_EMAIL = "delapaz@portal.app";
const DEMO_CLIENT_PASSWORD = "123456";
    ...
    <main className="app-shell" style={{ maxWidth: 390, minHeight: "92vh", display: "flex", alignItems: "center" }}>
      <section className="card" style={{ width: "100%", padding: 14 }}>
        <div style={{ display: "flex", justifyContent: "center", marginBottom: 10 }}>
          <Image src="/logo-decorazon.png" alt="Logo Decoazon" width={190} height={131} priority style={{ width: "100%", maxWidth: 190, height: "auto" }} />
        </div>
